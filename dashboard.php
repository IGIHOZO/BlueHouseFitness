                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>IGIHOZO Didier</td>
                        <td><a href="#" class="text-primary">2024-01-14 12:56:02</a></td>
                        <td>30,000 Rwf</td>
                        <td><span class="badge bg-success">Approved</span></td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#">#2147</a></th>
                        <td>MUKUNZI Christian</td>
                        <td><a href="#" class="text-primary">2024-01-10 12:56:02</a></td>
                        <td>45,000 Rwf</td>
                      ...
                      <tr>
                        ...
                        <td>ISHEMA Kevin</td>
                        <td><a href="#" class="text-primary">2024-01-12 12:56:02</a></td>
                        <td>Rwf 147</td>
                        <td><span class="badge bg-success">Approved</span></td>
                      </tr>
                      <tr>
                        ...
                        <td>KEZA Cynthia</td>
                        <td><a href="#" class="text-primar">2024-01-11 12:56:02</a></td>
                        <td>Rwf 67</td>
                        <td><span class="badge bg-danger">Rejected</span></td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#">#2644</a></th>
                        <td>RUGORI Cynthia</td>
                        <td><a href="#" class="text-primary">2024-01-12 11:56:02</a></td>
                        <td>Rwf 165</td>
                        <td><span class="badge bg-success">Approved</span></td>
                      </tr>
                    </tbody>
              ...
              <!-- <script>
                document.addEventListener("DOMContentLoaded", () => {
                  var budgetChart = echarts.init(document.querySelector("#budgetChart")).setOption({
                    legend: {
                      data: ['Subscribers', 'Non-Subscribers']
                    },
                    radar: {
                      // shape: 'circle',
                      indicator: [{
