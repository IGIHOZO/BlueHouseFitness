...
<head>
  ...
  <title>Expired Subscription Report - Blue Huose Fitness</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Expired Subscription Report</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Expired Subscription Report</h5>
...
document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch('main/view.php?expired_subscriptions=1')
                .then(response => {
                    if (!response.ok) {
